              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {!isLogin && (
                  <div className="space-y-2">
                    <Label htmlFor="nomComplet" className="text-slate-700 dark:text-slate-300">Nom complet</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-slate-700 dark:text-slate-300">Courriel</Label>
                  <div className="relative">
